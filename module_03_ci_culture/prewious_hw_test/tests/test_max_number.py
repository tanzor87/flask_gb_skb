...
from module_03_ci_culture.prewious_hw_test.max_number_app import app
...
class TestMaxNumberApp(unittest.TestCase):
    ...
    def test_can_get_correct_max_number_in_series_of_two(self):
        ...
        correct_ansver_str = f'<i>{max(numbers)}</i>'
        self.assertTrue(correct_ansver_str in response_text)
